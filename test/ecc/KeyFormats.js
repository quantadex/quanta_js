...
var test = function(key) {
    describe("KeyFormats", function() {
        ...
        describe("Key Formats", function() {
            ...
            it("QA public key import / export", function() {
                var public_key = PublicKey.fromPublicKeyString(key.public_key);
                assert.equal(key.public_key, public_key.toPublicKeyString());
            });
...
test({
    ...
    public_key: "QA7jDPoMwyjVH5obFmqzFNp4Ffp7G2nvC7FKFkrMBpo7Sy4uq5Mj",
    private_key:
    ...
    bts_address: "QA8DvGQqzbgCR5FHiNsFf8kotEXr8VKD3mR",
    ...
    Uncompressed_BTC: "QALAFmEtM8as1mbmjVcj5dphLdPguXquimn",
    Compressed_BTC: "QAANNTSEaUviJgWLzJBersPmyFZBY4jJETY",
    Uncompressed_PTS: "QAEgj7RM6FBwSoccGaESJLC3Mi18785bM3T",
    Compressed_PTS: "QAD5rYtofD6D4UHJH6mo953P5wpBfMhdMEi",
    null_public_key: "QA1111111111111111111111111111111114T1Anm"
});
